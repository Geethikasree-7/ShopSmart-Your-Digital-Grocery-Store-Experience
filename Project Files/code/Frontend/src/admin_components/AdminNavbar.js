...
const Unavbar = () => {
  ...
  return (
    <Navbar className='bg-blue-400' variant="dark" expand="lg" >
      <Container>
        <Navbar.Brand><Link to='/uhome' style={{color:"white",textDecoration:"none"}}>ShopSmart Web App</Link></Navbar.Brand>
