        ...
        <div>
            {isAdmin ?
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"red" }} expand="lg" bg="light" variant="light">
                    <Navbar.Brand><Link to='/admin/dashboard' style={{ textDecoration: 'none' }}>ShopSmartStore</Link></Navbar.Brand>
                ...
                <Navbar fixed="top" style={{ padding: '0 20px', minHeight: '10vh', width: '100%',backgroundColor:"#4CAF50" }} expand="lg" >
                    <Navbar.Brand><Link to='/' style={{ color: '#fff' , textDecoration: 'none' }}>ShopSmart Store</Link></Navbar.Brand>
                    <Navbar.Toggle aria-controls="navbarSupportedContent" />
                    <Navbar.Collapse id="navbarSupportedContent">
                        <Nav className="mr-auto">
